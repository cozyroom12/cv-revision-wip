...
class Mlp(nn.Module):
    # consist of twy linear layers with activation functions and dropout
...
class Attention(nn.Module):
    ...
    # linear transformations, attention dropout, and projection layers
...
class Block(nn.Module):
    ...
    # a self-attention layer with a feedforward MLP (neural network) layer.
...
class OverlapPatchEmbed(nn.Module):
    ...
    # img -> a sequence of overlapping patches
    # then applies conv operations to obtain embeddings
...
class MixVisionTransformer(BaseModule):
    # defines the MixVision Transformer
    # 1. patch embedding layers
    # 2. multiple transformer blocks for different stages
    # 3. classification head at last
    # highly configurable
